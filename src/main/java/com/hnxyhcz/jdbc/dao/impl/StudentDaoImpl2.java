...
public class StudentDaoImpl2 extends JdbcDaoSupport implements StudentDao{
	...
	public int addStudent(Student student) {
		...
		int i = this.getJdbcTemplate().update(INSERT_SQL, params);
		return i;
	}
	...
	public int updateStudent(Student student) {
		...
		return this.getJdbcTemplate().update(UPDATE_SQL, params);
	}
	...
	public int deleteStudent(int id) {
		...
		return this.getJdbcTemplate().update(DELETE_SQL, params);
	}
	...
	public List<Student> findStudent() {
		...
		this.getJdbcTemplate().query(FIND_SQL, new RowCallbackHandler(){
